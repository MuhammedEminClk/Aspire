...
using MuhammedTask.Services.ProductService.Application.Products.v1.Queries.Get;

namespace MuhammedTask.Services.ProductService.WebApi.Endpoints.Products.v1.Get;
