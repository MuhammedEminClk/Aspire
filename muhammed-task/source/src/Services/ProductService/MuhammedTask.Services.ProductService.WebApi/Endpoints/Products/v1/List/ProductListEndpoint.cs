...
using MuhammedTask.Services.ProductService.Application.Products.v1.Queries.List;

namespace MuhammedTask.Services.ProductService.WebApi.Endpoints.Products.v1.List;
