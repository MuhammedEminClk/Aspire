...
using MuhammedTask.Services.ProductService.Application.Categories.v1.Commands.Delete;

namespace MuhammedTask.Services.ProductService.WebApi.Endpoints.Categories.v1.Delete;
