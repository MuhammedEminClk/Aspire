...
using MuhammedTask.Services.ProductReviewService.Application.ServiceRegistrations;
using MuhammedTask.Services.ProductReviewService.Persistence.ServiceRegistrations;
using Microsoft.Net.Http.Headers;

namespace MuhammedTask.Services.ProductReviewService.WebApi.ServiceRegistrations;
...
internal static class DependencyInjection
{
        ...
        IConfiguration configuration)
    {
        ...
        return services
            ...
            .AddKeycloakJwtBearer(keycloakServiceId: ServiceKeys.Keycloak, realm: "product-reviews")
            .ConfigureTelemetries(hostEnvironment);
    }

    internal static WebApplication UseServices(this WebApplication app)
    {
