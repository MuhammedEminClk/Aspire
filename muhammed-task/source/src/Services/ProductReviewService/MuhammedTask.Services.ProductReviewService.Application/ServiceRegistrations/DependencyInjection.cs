...
using MuhammedTask.BuildingBlocks.Application.DependencyInjections;
using Microsoft.Extensions.DependencyInjection;

namespace MuhammedTask.Services.ProductReviewService.Application.ServiceRegistrations;
