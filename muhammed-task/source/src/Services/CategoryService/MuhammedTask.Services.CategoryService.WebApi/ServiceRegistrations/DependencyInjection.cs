...
using MuhammedTask.Services.CategoryService.Application.ServiceRegistrations;
using MuhammedTask.Services.CategoryService.Persistence.ServiceRegistrations;
using MuhammedTask.Services.Info;
using Microsoft.Net.Http.Headers;

namespace MuhammedTask.Services.CategoryService.WebApi.ServiceRegistrations;
